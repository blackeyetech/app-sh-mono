...
// Jira class here
export class Jira extends AppShPlugin {
  // Properties here
  ...
  public async logout(): Promise<void> {
    ...
    await this.httpReq(this._server, JiraResources.session, {
      method: "DELETE",
      headers: {
  ...
  public async getFieldDict(useCurrent: boolean = true): Promise<FieldDict> {
    ...
    let res = await this.httpReq(this._server, JiraResources.field, {
      method: "GET",
      headers:
  ...
  public async getAllowedFieldValues(
    ...
    let res = await this.httpReq(this._server, JiraResources.createmeta, {
      method: "GET",
      searchParams,
      headers:
        this._sessionId === null ? this._basicAuthHeader : this._sessionHeader,
  ...
  public async getProjects(component?: string): Promise<any[]> {
    let res = await this.httpReq(this._server, JiraResources.project, {
      method: "GET",
      headers:
        this._sessionId === null ? this._basicAuthHeader : this._sessionHeader,
  ...
  public async updateProject(
    ...
    await this.httpReq(this._server, `${JiraResources.project}/${project}`, {
      method: "PUT",
      headers:
        this._sessionId === null ? this._basicAuthHeader : this._sessionHeader,
      body,
  ...
  public async createIssue(
    ...
    let res = await this.httpReq(this._server, JiraResources.issue, {
      method: "POST",
      body: issue,
      headers:
        this._sessionId === null ? this._basicAuthHeader : this._sessionHeader,
  ...
  public async runJql(jql: string): Promise<string[]> {
    ...
    while (true) {
      let res = await this.httpReq(this._server, JiraResources.search, {
        method: "GET",
        headers:
          this._sessionId === null
            ? this._basicAuthHeader
  ...
  public async getUser(
    ...
    let res = await this.httpReq(this._server, JiraResources.user, {
      method: "GET",
      searchParams,
      headers:
        this._sessionId === null ? this._basicAuthHeader : this._sessionHeader,
  ...
  public async addUserToGroup(user: string, group: string): Promise<Object> {
    let res = await this.httpReq(this._server, `${JiraResources.group}/user`, {
      method: "POST",
  ...
  public async addUserToApplication(
    ...
    await this.httpReq(this._server, `${JiraResources.user}/application`, {
      method: "POST",
